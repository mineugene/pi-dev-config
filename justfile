...
# Install Graphify's hooks for this repository.
[group('graphify')]
graphify-hook:
    @{{ node }} {{ run_if_present }} graphify hook install

# Check whether Graphify's hooks are installed for this repository.
[group('graphify')]
graphify-hook-status:
    @{{ node }} {{ run_if_present }} graphify hook status

# Remove Graphify's hooks from this repository.
[group('graphify')]
graphify-hook-remove:
    @{{ node }} {{ run_if_present }} graphify hook uninstall

# Watch this repository and rebuild its Graphify graph after changes.
[group('graphify')]
graphify-watch:
    @{{ node }} {{ run_if_present }} graphify watch .
