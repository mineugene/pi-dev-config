...
/**
 * True while a plan is active and unfinished. The auto-compact policy reads this
 * to tell a task boundary from a mid-plan stop; the list itself stays owned here.
 */
export function todosOpen(): boolean {
